			...
			<div class="row mb-2">
				<div class="col-sm-12">
					<ul class="nav nav-pills text-bold">
						...
						<li class="nav-item">
							<a class="nav-link active" href="terdaftar.php">Pendaftar</a>
						</li>
						<li class="nav-item">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div class="card">
						...
						<!-- /.card-header -->
						<div class="card-body">
							<h3 class="headerw3">Data Pendaftar</h3>
							<hr>
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									...
									$sql = mysqli_query($connect, "SELECT * from pendaftar_santri WHERE arsip = 'Tidak' AND keterangan = 'Belum Terverifikasi' ");
									$no = 1;
