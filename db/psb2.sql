...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2021 at 08:29 AM
...
INSERT INTO `admin` (`no_induk`, `nama_admin`, `jk`, `alamat`, `tmp_lahir`, `tgl_lahir`, `foto`, `idu`) VALUES
('123', 'ERADIKA REZA ', 'Perempuan', 'banjarnegara', 'banjarnega', '1999-09-29', 'ERADIKA REZA Lutfiansyah-DSC_2205.JPG', '123'),
('123456789', 'Administrator', 'Laki-laki', 'Banyumas', 'Banyumas', '2021-02-10', 'Administrator-Logo PPDS.png', '123456789');
...
INSERT INTO `kelas` (`id_kelas`, `kelas`, `nilai_awal`, `nilai_akhir`) VALUES
(4, 'Diniyah Kelas 1', 0, 50),
(5, 'Diniyah Kelas 2', 51, 80),
(6, 'Diniyah Kelas 3', 81, 100);
...
INSERT INTO `pendaftaran` (`id_pendaftaran`, `periode`, `tgl_mulai`, `tgl_selesai`, `kuota`, `aktif`) VALUES
(27, 'feb-maret', '2021-02-10', '2021-03-11', 100, 'Ya');

-- --------------------------------------------------------

--
-- Table structure for table `pendaftar_santri`
--
...
--
-- Dumping data for table `pendaftar_santri`
--

INSERT INTO `pendaftar_santri` (`no_daftar`, `nik`, `nama_santri`, `jk`, `alamat`, `tempat_lahir`, `tgl_lahir`, `goldar`, `anak_ke`, `jml_saudara`, `notelp`, `cita`, `hobi`, `asal_sekolah`, `prestasi`, `program`, `nama_ayah`, `nama_ibu`, `kerja_ayah`, `kerja_ibu`, `alamat_ortu`, `penghasilan_ortu`, `notelp_ortu`, `ktp`, `foto`, `kk`, `pembayaran`, `tgl_daftar`, `keterangan`, `arsip`, `id_daftar`, `id_kelas`) VALUES
('P11022021002', '330411070100001', 'heraya', 'Laki - laki', 'asdasdasd', 'banjarnegara', '2021-02-03', 'A', 3, 5, '0766767', 'presiden', 'VOLI', 'bawang', 1, 1, 'jhdhsads', 'dbsahdsahgd', 'hsagdhgadsh', 'hdgashgdh', 'hhdashdghsad', 'Rp.500.000,. s/d Rp.1.000.000,.', '87892738272', 'sd-cibatuireng1.jpg', 'e.jpg', 'WhatsApp-Image-2018-05-17-at-08.33.111.jpeg', 'Untitled.png', '2021-02-11', 'Belum Terverifikasi', 'Tidak', 27, NULL),
('P12022021002', '17120120', 'ERADIKA REZA', 'Laki - laki', 'saasdasd', 'dassadsad', '2021-02-03', 'a', 2, 3, '342424', 'fdsfds', 'sdfdsf', 'bawang', 3, 2, 'was', 'wer', 'asdsad', 'sdasda', 'dassad', 'Rp.500.000,. s/d Rp.1.000.000,.', '324242432', 'sd-cibatuireng1.jpg', 'e.jpg', 'WhatsApp-Image-2018-05-17-at-08.33.111.jpeg', 'Untitled.png', '2021-02-02', 'Belum Terverifikasi', 'Tidak', 27, 4);
...
CREATE TABLE `pengguna` (
  ...
  `hak_akses` enum('Admin','Superadmin','Santri') NOT NULL,
  `tgl_daftar` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pengguna` (`nik`, `nama_pengguna`, `password`, `pass_asli`, `email`, `hak_akses`, `tgl_daftar`) VALUES
('12243', 'riko antonio', '8eccf077b0fa955b178383cf55a683be', '1', 'eradik7@gmail.com', 'Santri', '2021-02-12'),
('123456789', 'Administrator', '0fd490ba3432bc55bd8a6bc127492ce4', 'admin', 'admin@gmail.com', 'Superadmin', '2018-03-15'),
('17120120', 'ERADIKA REZA', '8eccf077b0fa955b178383cf55a683be', '1', 'eradik7@gmail.com', 'Santri', '2021-02-11'),
('330411070100001', 'heraya', 'c4ca4238a0b923820dcc509a6f75849b', '1', 'santri@gmail.com', 'Santri', '2021-02-10');
...
CREATE TABLE `provinsi` (
  `id_prov` char(2) COLLATE utf8_unicode_ci NOT NULL,
  `nama_prov` varchar(30) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `soal` (`id_soal`, `soal`, `a`, `b`, `c`, `d`, `kunci`, `tanggal`, `aktif`) VALUES
(2, '<p>Siapa yang mengembangkan Sejarah Web pertama kali?</p>', 'Ruben', 'Thomas Alpha Edison', 'Tim Berners-Lee', 'Albert ', 'c', '2018-07-02', 'Y'),
...
(7, 'Menurut Anda, di bawah ini adalah gambar?', 'Avatar', 'Pelangi', 'Singa Laut', 'Bulan', 'a', '2020-10-04', 'Y'),
(9, 'jarak suarabaya', 'ee', 'era', '3', 's', 'c', '0000-00-00', 'Y'),
(10, 'sdadas', 'ee', 'era', '333333333333333333', 'qq', 'c', '0000-00-00', 'N');
...
--
-- Constraints for table `pendaftar_santri`
--
ALTER TABLE `pendaftar_santri`
  ADD CONSTRAINT `pendaftar_santri_ibfk_1` FOREIGN KEY (`prestasi`) REFERENCES `prestasi` (`id_prestasi`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pendaftar_santri_ibfk_2` FOREIGN KEY (`program`) REFERENCES `program` (`id_program`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pendaftar_santri_ibfk_3` FOREIGN KEY (`id_kelas`) REFERENCES `kelas` (`id_kelas`);
COMMIT;
