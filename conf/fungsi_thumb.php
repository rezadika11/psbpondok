<?php
//------------------------------------------------ UPLOAD FAVICON -----------------------------------------------//
function UploadFav($fupload_name){
  //direktori gambar
  $vdir_upload = "../fav/";
  ...
  //Simpan dalam versi small 32 pixel
...
/*------------------------------------------------ UNTUK GAMBAR CARA DAFTAR ------------------------------------------------*/
function UploadCaraDaftar($fupload_name){
  //direktori gambar
  $vdir_upload = "img_caradaftar/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
...
function UploadStruk($fupload_name){
  //direktori gambar
  $vdir_upload = "img_payment/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $imageType = $_FILES["fupload"]["type"];
